...
\includepdf[pages=1,scale=0.8, offset= 0 -3cm,
pagecommand={\chapter{Carta describiendo los errores econtrados en los dispositivos Touch}
...
pagecommand={\chapter{Interactive learning environment for diagnostic radiographywith real-time X-ray simulation and patient positioning}
